// Category definitions with matchers that operate on Open Food Facts product shape.
// Shared between API and PWA.
...
export const SNAP_CATEGORIES = {
  ...
  dessert: {
    label: "Prepared Dessert", tone: "bad",
  ...
  sweet_bev: {
    label: "Sweetened Beverage", tone: "bad",
  ...
  juice_drink: {
    label: "Juice Drink (<50% juice)", tone: "bad",
